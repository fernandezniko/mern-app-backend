...
const getUsers = async (req, res, next) => {
    ...
    try {
        ...
        const error = new HttpError(
            'Fetching users failed, please try it again later',
            500
        )
...
const signUp = async (req, res, next) => {
    ...
    try {
        ...
        const error = new HttpError(
            'Singning up failed, please try it again later',
            500
        )
        return next(error);
    }
    ...
    try {
        ...
        const error = new HttpError(
            'Singning up failed, please try again.',
            500
        );
        return next(error);
    }
...
const login = async (req, res, next) => {
    ...
    try {
        ...
        const error = new HttpError(
            'Logging in failed, please try it again later',
            500
        )
